  ...
  return (
    <footer className="py-12 bg-secondary">
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-2xl font-bold uppercase mb-2 text-secondary-foreground">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <motion.button
              className="btn-web3 bg-destructive text-destructive-foreground px-6 py-3"
            ...
            <motion.button
              className="btn-outline-web3 text-secondary-foreground"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              FOLLOW TWITTER
